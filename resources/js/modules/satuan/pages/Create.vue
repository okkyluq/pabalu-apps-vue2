            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-8 offset-sm-3">
                        ...
                        <button @click="$store.dispatch('SatuanStoreCreate/toggleSidebar', false)" type="button" class="btn btn-danger btn-flat">Batal</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...mapState('SatuanStoreCreate', {
            form: state => state.form,
            visible_sidebar: state => state.visible_sidebar
        })
    },
    methods: {
        ...mapActions('SatuanStoreCreate', {
            clearForm: 'clearForm',
        ...
        sendForm(){
			...
			this.$axios.post('satuan', formData)
				.then(response => {
                    if(response.status === 200){
                        this.$store.dispatch('SatuanStoreCreate/toggleSidebar', false);
